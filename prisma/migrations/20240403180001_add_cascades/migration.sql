...
CREATE TABLE "new_attendees" (
    ...
    "name" TEXT NOT NULL,
    "email" TEXT NOT NULL,
    "created_map" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "event_id" TEXT NOT NULL,
    CONSTRAINT "attendees_event_id_fkey" FOREIGN KEY ("event_id") REFERENCES "events" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO "new_attendees" ("created_map", "email", "event_id", "id", "name") SELECT "created_map", "email", "event_id", "id", "name" FROM "attendees";
...
INSERT INTO "new_check_ins" ("attendee_id", "created_map", "id") SELECT "attendee_id", "created_map", "id" FROM "check_ins";
